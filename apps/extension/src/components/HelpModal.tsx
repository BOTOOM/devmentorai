import { Globe, HelpCircle, MessageCircle, Palette, X } from 'lucide-react';
        ...
        <div className="p-6 space-y-6">
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              DevMentorAI is your AI-powered assistant for DevOps mentoring, writing assistance, and
              development help. It uses GitHub Copilot to provide intelligent responses tailored to
              your needs.
            </p>
          </section>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <span className="text-gray-600 dark:text-gray-400">
                    {' '}
                    AWS, Azure, GCP, Kubernetes, CI/CD, Infrastructure
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <span className="text-gray-600 dark:text-gray-400">
                    {' '}
                    Email writing, translation, rewriting, grammar fixes
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-2">
