...
test.describe('Keyboard Shortcuts', () => {
  ...
  test.describe('Session Creation', () => {
    test('should open new session modal with Ctrl+Shift+N', async ({ sidePanelPage }) => {
      ...
      const modal = sidePanelPage
        .locator('[role="dialog"]')
        .or(sidePanelPage.getByText(/new session/i))
        .or(sidePanelPage.getByText(/create session/i));
  ...
  test.describe('Help Modal', () => {
    test('should show help with Ctrl+/', async ({ sidePanelPage }) => {
      ...
      const helpContent = sidePanelPage
        .getByText(/keyboard shortcuts/i)
        .or(sidePanelPage.locator('[role="dialog"]'));
  ...
  test.describe('Arrow Key Navigation', () => {
    test('should handle arrow keys in session list', async ({ sidePanelPage }) => {
      ...
      const sessionList = sidePanelPage
        .locator('[role="listbox"]')
        .or(sidePanelPage.locator('[class*="session"]'))
        .first();
  ...
  test.describe('Settings Shortcut', () => {
    test('should open settings with Ctrl+Shift+S', async ({ sidePanelPage }) => {
      ...
      const settingsContent = sidePanelPage
        .getByText(/settings/i)
        .or(sidePanelPage.getByRole('button', { name: /setting/i }));
