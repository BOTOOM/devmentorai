 ...
 */
export type QuickActionStreamMessageType = 'QUICK_ACTION_STREAM_START' | 'QUICK_ACTION_STREAM_DELTA' | 'QUICK_ACTION_STREAM_COMPLETE' | 'QUICK_ACTION_STREAM_ERROR';
...
export type QuickActionStreamMessage = QuickActionStreamStartMessage | QuickActionStreamDeltaMessage | QuickActionStreamCompleteMessage | QuickActionStreamErrorMessage;
