...
export function registerToolsRoutes(app: FastifyInstance, copilotService: CopilotService): void {
  ...
  app.post(
    '/api/tools/execute',
    async (request: FastifyRequest<{ Body: ToolExecuteBody }>, reply: FastifyReply) => {
