...
export default function DocsSettingsPage() {
  ...
  return (
    <>
      ...
      <HeroSection
        badge={
          <Badge icon={<Settings className="h-3 w-3" />}>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-20 sm:px-6 md:pb-24">
        <div className="grid gap-4 md:grid-cols-[2fr_1fr]">
          <article className="rounded-2xl border border-[var(--card-border)] bg-[var(--section-alt)] p-5 sm:p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-[var(--muted)] sm:text-base">
              ...
              <li>Appearance and language settings control extension visual behavior and locale intent.</li>
              <li>Smart Translation, screenshots, and quick action model settings directly affect writing workflows.</li>
            </ul>
          </article>
          ...
          <aside className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-5 sm:p-6">
            ...
            <nav aria-label="Settings docs table of contents" className="mt-3 space-y-2 text-sm">
              <a href="#backend" className="block rounded-md px-2 py-1.5 text-[var(--muted)] transition-colors hover:bg-[var(--section-alt)] hover:text-primary">
                Backend connection
              </a>
              <a href="#appearance" className="block rounded-md px-2 py-1.5 text-[var(--muted)] transition-colors hover:bg-[var(--section-alt)] hover:text-primary">
                Appearance
              </a>
              <a href="#translation" className="block rounded-md px-2 py-1.5 text-[var(--muted)] transition-colors hover:bg-[var(--section-alt)] hover:text-primary">
                Smart Translation
              </a>
              <a href="#screenshots" className="block rounded-md px-2 py-1.5 text-[var(--muted)] transition-colors hover:bg-[var(--section-alt)] hover:text-primary">
                Images and screenshots
              </a>
              <a href="#quick-actions" className="block rounded-md px-2 py-1.5 text-[var(--muted)] transition-colors hover:bg-[var(--section-alt)] hover:text-primary">
        ...
        <article id="backend" className="mt-6 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-5 sm:p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm text-[var(--muted)] sm:text-base">
            ...
            <li>Use <strong className="text-[var(--foreground)]">Test Connection</strong> to verify health endpoint response.</li>
            <li>Useful when your backend runs on a custom port or private server URL.</li>
          </ul>
        </article>

        <article id="appearance" className="mt-6 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-5 sm:p-6">
          <h2 className="inline-flex items-center gap-2 text-xl font-bold tracking-tight sm:text-2xl">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-[var(--card-border)] bg-[var(--section-alt)] p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-[var(--muted)] sm:text-base">
                Interface language selection exists, but browser extension locale behavior can still depend on browser language defaults.
              </p>
            </div>
          </div>
        </article>

        <article id="translation" className="mt-6 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-5 sm:p-6">
          <h2 className="inline-flex items-center gap-2 text-xl font-bold tracking-tight sm:text-2xl">
        ...
        <article id="screenshots" className="mt-6 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-5 sm:p-6">
          <h2 className="inline-flex items-center gap-2 text-xl font-bold tracking-tight sm:text-2xl">
          ...
          <ul className="mt-4 space-y-2 text-sm text-[var(--muted)] sm:text-base">
            ...
            <li>
              Asking mode prompts before capture; auto mode captures immediately when context mode is enabled.
            </li>
          </ul>
        </article>

        <article id="quick-actions" className="mt-6 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-5 sm:p-6">
          <h2 className="inline-flex items-center gap-2 text-xl font-bold tracking-tight sm:text-2xl">
            <Cog className="h-5 w-5 text-primary" />
            Quick action model and updates
          </h2>
          <ul className="mt-4 space-y-2 text-sm text-[var(--muted)] sm:text-base">
            <li>Select default quick action model for actions like grammar fix, rewrite, and translate.</li>
