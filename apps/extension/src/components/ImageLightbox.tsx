    ...
    >
      ...
      >
        ...
        <button
          type="button"
          className={cn(
            'block appearance-none border-0 bg-transparent p-0',
        ...
        <>
          <button
            ...
            className={cn(
              ...
              canGoPrev ? 'hover:bg-black/70 cursor-pointer' : 'opacity-30 cursor-not-allowed'
            )}
          ...
          <button
            ...
            className={cn(
              ...
              canGoNext ? 'hover:bg-black/70 cursor-pointer' : 'opacity-30 cursor-not-allowed'
            )}
            title="Next image"
          >
