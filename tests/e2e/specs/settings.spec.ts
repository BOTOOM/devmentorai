...
test.describe('Settings Page', () => {
  ...
  test.describe('Theme Settings', () => {
    ...
    test('should be able to select dark theme', async ({ optionsPage }) => {
      ...
      const darkOption = optionsPage
        .getByRole('radio', { name: /dark/i })
        .or(optionsPage.getByLabel(/dark/i))
        .or(optionsPage.locator('[value="dark"]'));
    ...
    test('should be able to select light theme', async ({ optionsPage }) => {
      const lightOption = optionsPage
        .getByRole('radio', { name: /light/i })
        .or(optionsPage.getByLabel(/light/i))
        .or(optionsPage.locator('[value="light"]'));
    ...
    test('should be able to select system theme', async ({ optionsPage }) => {
      const systemOption = optionsPage
        .getByRole('radio', { name: /system/i })
        .or(optionsPage.getByLabel(/system/i))
        .or(optionsPage.locator('[value="system"]'));
  ...
  test.describe('Backend Connection', () => {
    test('should display backend URL input', async ({ optionsPage }) => {
      const backendInput = optionsPage
        .getByLabel(/backend/i)
        .or(optionsPage.locator('input[placeholder*="localhost"]'))
        .or(optionsPage.locator('input[type="url"]'));
    ...
    test('should show connection status', async ({ optionsPage }) => {
      ...
      const statusIndicator = optionsPage
        .locator('[class*="status"]')
        .or(optionsPage.getByText(/connected|disconnected|connecting/i));
  ...
  test.describe('UI Features', () => {
    test('should have floating bubble toggle', async ({ optionsPage }) => {
      const toggle = optionsPage
        .getByLabel(/floating bubble/i)
        .or(optionsPage.getByText(/floating bubble/i));
  ...
  test.describe('Session Defaults', () => {
    test('should have default session type selector', async ({ optionsPage }) => {
      const sessionTypeSection = optionsPage
        .getByText(/session type/i)
        .or(optionsPage.getByText(/default session/i));
  ...
  test.describe('Quick Actions', () => {
    test('should have text replacement behavior setting', async ({ optionsPage }) => {
      const replacementSection = optionsPage
        .getByText(/text replacement/i)
        .or(optionsPage.getByText(/replace/i));
    ...
    test('should have quick action model selector', async ({ optionsPage }) => {
      const modelSection = optionsPage
        .getByText(/quick action/i)
        .or(optionsPage.getByText(/model/i));
  ...
  test.describe('Language Settings', () => {
    test('should have language selector', async ({ optionsPage }) => {
      const languageSection = optionsPage
        .getByLabel(/language/i)
        .or(optionsPage.getByText(/language/i));
